...
function demosShow() {
    document.getElementById("sla").classList.add('open-sla');
    document.getElementById("sidebar-demos-overlay").classList.add('open-sla-overlay');
}
function demosClose() {
    document.getElementById("sla").classList.remove('open-sla');
    document.getElementById("sidebar-demos-overlay").classList.remove('open-sla-overlay');
}
